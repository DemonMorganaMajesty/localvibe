-- =====================================================================
-- information 库建表脚本（以用户提供的表结构为准，不改动任何已有表）
-- 适用数据库: WSL MySQL 172.24.116.171:3307 的 information 库
-- 说明: 仅 CREATE TABLE IF NOT EXISTS，可重复执行
-- =====================================================================
USE information;
...
(
    ...
    create_time timestamp default CURRENT_TIMESTAMP     not null comment '创建时间',
    begin_time  timestamp default '2020-01-01 00:00:00' not null comment '生效时间',
    end_time    timestamp default '2020-01-01 00:00:00' not null comment '失效时间',
    update_time timestamp default CURRENT_TIMESTAMP     not null on update CURRENT_TIMESTAMP comment '更新时间'
)
